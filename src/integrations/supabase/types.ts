...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      vendas_completas: {
        Row: {
          alpha_program: Json | null
          analytics_data: Json | null
          attribution_data: Json | null
          beta_program: Json | null
          buyer_address: Json | null
          buyer_address_billing: Json | null
          buyer_alternative_phone: Json | null
          buyer_billing_info: Json | null
          buyer_email: string | null
          buyer_first_name: string | null
          buyer_id: string | null
          buyer_identification: Json | null
          buyer_last_name: string | null
          buyer_nickname: string | null
          buyer_phone: Json | null
          buyer_reputation: Json | null
          buyer_tags: Json | null
          change_date_created: string | null
          change_estimated_exchange_date: Json | null
          change_id: string | null
          change_new_orders_ids: Json | null
          change_reason: Json | null
          change_status: string | null
          change_tracking_info: Json | null
          change_type: string | null
          claim_date_created: string | null
          claim_id: string | null
          claim_last_updated: string | null
          claim_participants: Json | null
          claim_reason_id: string | null
          claim_related_entities: Json | null
          claim_resolution: Json | null
          claim_stage: string | null
          claim_status: string | null
          claim_type: string | null
          context_application_id: string | null
          context_beta_feature: Json | null
          context_channel: string | null
          context_device: string | null
          context_flows: Json | null
          context_site: string | null
          ...
          discount_campaigns: Json | null
          endpoints_accessed: Json | null
          experience_decorations: Json | null
          feedback_buyer_date_created: string | null
          feedback_buyer_fulfilled: boolean | null
          feedback_buyer_id: string | null
          feedback_buyer_message: string | null
          feedback_buyer_rating: string | null
          feedback_buyer_reply: Json | null
          feedback_sale_id: string | null
          feedback_seller_date_created: string | null
          feedback_seller_fulfilled: boolean | null
          feedback_seller_id: string | null
          feedback_seller_message: string | null
          feedback_seller_rating: string | null
          feedback_seller_reply: Json | null
          fulfillment_date_created: string | null
          fulfillment_estimated_delivery: string | null
          fulfillment_id: string | null
          fulfillment_preference: Json | null
          fulfillment_status: string | null
          fulfillment_type: string | null
          id: number
          invoice_data: Json | null
          invoice_date_created: string | null
          invoice_id: string | null
          invoice_status: string | null
          item_bundle: Json | null
          item_catalog_product_id: string | null
          item_category_id: string | null
          item_condition: string | null
          item_differential_pricing: Json | null
          item_full_unit_price: number | null
          item_global_price: number | null
          item_id: string | null
          item_listing_type_id: string | null
          item_manufacturing_days: number | null
          item_picture_urls: Json | null
          item_quantity: number | null
          item_sale_fee: number | null
          item_seller_custom_field: string | null
          item_seller_sku: string | null
          item_title: string | null
          item_unit_price: number | null
          item_variation_attributes: Json | null
          ...
          messages_from_buyer: number | null
          messages_from_seller: number | null
          order_context: Json | null
          order_currency_id: string | null
          order_date_closed: string | null
          order_date_created: string | null
          order_expiration_date: string | null
          order_fulfilled: boolean | null
          order_id: string
          order_last_updated: string | null
          order_manufacturing_ending_date: string | null
          order_manufacturing_start_date: string | null
          order_mediations: Json | null
          order_pack_id: string | null
          ...
          organization_id: string
          payment_atm_transfer_reference: Json | null
          payment_authorization_code: string | null
          payment_available_actions: Json | null
          payment_card_first_six_digits: string | null
          payment_card_id: string | null
          payment_card_last_four_digits: string | null
          payment_coupon_amount: number | null
          payment_date_approved: string | null
          payment_date_created: string | null
          payment_date_last_modified: string | null
          payment_deferred_period: string | null
          payment_id: string | null
          payment_installment_amount: number | null
          payment_installments: number | null
          payment_issuer_id: string | null
          payment_issuer_name: string | null
          payment_method_id: string | null
          payment_operation_type: string | null
          payment_overpaid_amount: number | null
          payment_payment_type_id: string | null
          payment_shipping_cost: number | null
          payment_status: string | null
          payment_status_detail: string | null
          payment_taxes_amount: number | null
          payment_total_paid_amount: number | null
          payment_transaction_amount: number | null
          payment_transaction_amount_refunded: number | null
          promotion_amount: number | null
          promotion_id: string | null
          promotion_type: string | null
          quality_evaluation: Json | null
          raw_claims_data: Json | null
          raw_feedback_data: Json | null
          raw_messages_data: Json | null
          raw_order_data: Json | null
          raw_payment_data: Json | null
          raw_shipping_data: Json | null
          return_cause: Json | null
          return_date_created: string | null
          return_id: string | null
          return_intermediate_check: Json | null
          return_refund_at: string | null
          return_resolution: Json | null
          ...
          seller_eshop: Json | null
          seller_first_name: string | null
          seller_id: string | null
          seller_last_name: string | null
          seller_nickname: string | null
          seller_phone: Json | null
          seller_reputation: Json | null
          seller_status: Json | null
          seller_tags: Json | null
          shipping_application_id: string | null
          shipping_comments: string | null
          shipping_cost: number | null
          shipping_date_created: string | null
          shipping_date_delivered: string | null
          shipping_date_first_printed: string | null
          shipping_date_shipped: string | null
          shipping_delay: Json | null
          shipping_dimensions: Json | null
          shipping_estimated_delivery_date: string | null
          shipping_estimated_delivery_time: Json | null
          shipping_estimated_handling_limit: string | null
          shipping_gross_amount: number | null
          shipping_handling_time: number | null
          shipping_id: string | null
          shipping_local_pick_up: boolean | null
          shipping_logistic_type: string | null
          shipping_market_place: string | null
          shipping_method: string | null
          shipping_mode: string | null
          shipping_net_amount: number | null
          shipping_option: Json | null
          shipping_preferences: Json | null
          shipping_priority: string | null
          shipping_receiver_address: Json | null
          shipping_sender_address: Json | null
          shipping_service_id: string | null
          shipping_status: string | null
          shipping_store_pick_up: boolean | null
          shipping_substatus: string | null
          shipping_tags: Json | null
          shipping_tracking_method: string | null
          shipping_tracking_number: string | null
          shipping_type: string | null
          sync_duration_ms: number | null
          sync_errors: Json | null
          tax_exempted: boolean | null
          taxes_amount: number | null
          taxes_currency_id: string | null
