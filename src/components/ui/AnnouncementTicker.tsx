            ...
            <div className="flex items-center gap-2">
              ...
              {currentAnnouncement.href && (
                <Button
                  ...
                  className="h-6 px-2 text-inherit hover:bg-gray-200 dark:hover:bg-amber-500/20 text-xs"
                >
          ...
          {announcements.length > 1 && (
            <>
              <Button
                ...
                className="h-6 w-6 p-0 text-inherit hover:bg-gray-200 dark:hover:bg-amber-500/20"
              >
