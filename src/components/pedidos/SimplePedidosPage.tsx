...
export default function SimplePedidosPage({ className }: Props) {
  ...
  return (
    <div className={`space-y-6 p-6 ${className}`}>
      ...
      {/* 🚀 PRIORIDADE 2: Filtros Otimizados com Memoização */}
      <Card className="p-6">
        <PedidosFiltersMemo
          filters={filters}
        ...
        {/* 🔄 Botão para aplicar filtros - Sempre visível quando há filtros */}
        <div className="flex justify-center mt-4 gap-2">
          <Button onClick={actions.applyFilters} disabled={!hasPendingChanges}>
