 ...
 * 🎯 EVOLUÍDA: Fases 1-4 completas + Modularizada
 * 
...
import { VendasFilterBar } from '../components/VendasFilterBar';
import { VendasOnlineTable } from '../components/VendasOnlineTable';
import { VendasPaginationFooter } from '../components/VendasPaginationFooter';
import { VendasResumo, type FiltroResumo } from '../components/VendasResumo';
import { VendasAnotacoesModal } from '../components/modals/VendasAnotacoesModal';
import { useVendasData } from '../hooks/useVendasData';
import { useVendasStore } from '../store/vendasStore';
import { useVendasFiltersUnified } from '../hooks/useVendasFiltersUnified';
...
import { useVendaStorage } from '../hooks/useVendaStorage';
import type { StatusAnalise } from '../types/venda-analise.types';
import { STATUS_ATIVOS, STATUS_HISTORICO } from '../types/venda-analise.types';
...
export function VendasCanceladasPage() {
  ...
  const visibleColumnKeys = useMemo(() => {
    ...
    console.log('🔄 [VendasCanceladasPage] visibleColumnKeys recalculado:', {
  ...
  console.log('🎯 [VendasCanceladasPage] Colunas visíveis:', {
