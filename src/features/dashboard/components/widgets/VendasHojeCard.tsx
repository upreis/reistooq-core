...
export function VendasHojeCard({ selectedAccount = "todas" }: VendasHojeCardProps) {
  ...
  return (
    <motion.div
      className="md:col-span-1 md:row-span-1 bg-background border border-border rounded-xl p-4 flex flex-col hover:border-primary/50 transition-colors cursor-pointer overflow-hidden relative"
