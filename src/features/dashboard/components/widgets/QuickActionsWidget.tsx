  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-gray-800/90 text-white text-xs px-2 py-1 rounded-md whitespace-nowrap pointer-events-none backdrop-blur-sm z-50"
      >
        {item.name}
      </motion.div>
      ...
      <section className="w-full py-6">
        <div className="container mx-auto px-4 md:px-6 flex items-center justify-center">
          <motion.div
            ...
            className="flex h-24 items-end gap-4 rounded-3xl bg-muted/40 backdrop-blur-md px-6 pb-4 border-2 border-border/20 shadow-xl"
