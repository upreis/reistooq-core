        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Configure a estrutura hierárquica de categorias: Categoria Principal → Categoria
            </p>
          </div>
        </div>
      </div>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="bg-muted p-4 rounded-lg">
            ...
            <div className="text-sm text-muted-foreground space-y-1">
              <div>📱 Eletrônicos → Smartphones</div>
              <div>📱 Eletrônicos → Tablets</div>
              <div>🏠 Casa, Móveis e Decoração → Decoração</div>
              <div>🏠 Casa, Móveis e Decoração → Móveis</div>
            </div>
          </div>
          
          <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
            <p className="text-sm text-yellow-800">
              <strong>Importante:</strong> Todos os produtos podem ser associados a uma categoria de 2 níveis. 
              A estrutura é simples: Categoria Principal → Categoria.
            </p>
          </div>
        </CardContent>
      </Card>
