...
export default function DashboardVisaoGeral() {
  ...
  return (
    <div className="space-y-6 p-6 bg-card w-full">
      {/* Layout principal: Coluna esquerda (Vendas + Acesso Rápido) e Coluna direita (outros cards) */}
      <div className="grid gap-6 lg:grid-cols-[0.7fr_2.8fr]">
        {/* Coluna Esquerda: Card Vendas + Acesso Rápido */}
