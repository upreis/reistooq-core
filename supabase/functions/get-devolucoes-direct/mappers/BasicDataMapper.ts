...
export const mapBasicData = (item: any, accountId: string, accountName: string, reasonId: string | null) => {
  ...
  return {
    ...
    // 📅 Data da venda original (quando foi feita a compra)
    ...
    subtipo_claim: returnData?.subtype || claim.stage || null,
    ...
    // 👥 Entidades relacionadas (rastreabilidade completa)
    entidades_relacionadas: {
      ...
      claim_id: claim.id?.toString() || null,
      return_id: returnData?.id?.toString() || null
    }
  };
};
