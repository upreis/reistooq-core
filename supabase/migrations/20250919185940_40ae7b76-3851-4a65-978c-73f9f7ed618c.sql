-- Fix invitation system issues: permissions, duplicates prevention, and deletion
...
-- 4. Add unique constraint to prevent duplicate pending invitations
CREATE UNIQUE INDEX IF NOT EXISTS unique_pending_invitations 
