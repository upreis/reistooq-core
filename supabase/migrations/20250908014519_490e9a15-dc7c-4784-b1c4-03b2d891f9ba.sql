-- AUDITORIA COMPLETA: Remove TODAS as versões conflitantes da get_pedidos_masked
-- Deixar apenas a versão simples e funcional

-- Drop ALL versions of get_pedidos_masked to avoid conflicts
...
-- Create ONLY ONE clean version - the simple one that works
