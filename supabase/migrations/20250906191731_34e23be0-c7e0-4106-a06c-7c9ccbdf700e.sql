...
INSERT INTO public.audit_logs (
  ...
  'rls_policies',
  jsonb_build_object(
    'enhancement', 'Added permission-based access control and data masking',
    'policies_updated', 'All CRUD operations now require appropriate permissions',
    'masked_fields', 'nome_completo, cpf_cnpj, email, telefone, endereco_rua, endereco_numero, endereco_cep'
  )
);