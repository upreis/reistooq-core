-- Update RPC to include id_unico in the _search filter
...
IS 'Safe reader for historico_vendas (includes id_unico in search), returns non-sensitive columns with filters & pagination.';