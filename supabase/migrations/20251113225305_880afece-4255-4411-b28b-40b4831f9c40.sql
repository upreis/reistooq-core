...
-- Comentários
COMMENT ON FUNCTION public.update_ml_devolucoes_updated_at() IS 'Protegido com SET search_path = public';
COMMENT ON FUNCTION public.update_unified_orders_updated_at() IS 'Protegido com SET search_path = public';
COMMENT ON FUNCTION public.update_fila_updated_at() IS 'Protegido com SET search_path = public';
COMMENT ON FUNCTION public.calcular_dias_restantes_acao() IS 'Protegido com SET search_path = public';
COMMENT ON FUNCTION public.verificar_alertas_tempo_real() IS 'Protegido com SET search_path = public';
COMMENT ON FUNCTION public.migrate_existing_orders_to_unified() IS 'Protegido com SET search_path = public';
COMMENT ON FUNCTION public.revoke_invitation(uuid) IS 'Protegido com SET search_path = public';