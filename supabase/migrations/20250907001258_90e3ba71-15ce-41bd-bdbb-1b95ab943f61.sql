-- Enhanced security for customer data protection
-- 1. Create enhanced masking function that logs access
...
-- 4. Create function to check time-based access (optional enhancement)
...
-- 5. Enhanced RLS policy for clientes table with additional security checks
...
-- 6. Create function to audit customer data access
...
GRANT EXECUTE ON FUNCTION public.is_business_hours() TO authenticated;