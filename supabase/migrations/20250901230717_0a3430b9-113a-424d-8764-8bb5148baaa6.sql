...
-- ===========================================
-- TRIGGERS PARA SETAR ORGANIZATION_ID AUTOMATICAMENTE
-- ===========================================

-- Trigger para logistic_events
...
CREATE TRIGGER set_logistic_events_organization
  BEFORE INSERT ON public.logistic_events
  FOR EACH ROW
  EXECUTE FUNCTION public.set_logistic_events_organization();
...
CREATE TRIGGER set_notes_organization
...
BEGIN
  ...
  IF (p_pedido_data->>'situacao') IN ('pendente', 'processando') THEN
    INSERT INTO public.logistic_events (
      ...
      notification_days_before, notes, organization_id
    ) VALUES (
      ...
      1, 'Evento criado automaticamente pelo sistema', v_org_id
  ...
  INSERT INTO public.logistic_events (
    ...
    p_pedido_data->>'nome_cliente', p_pedido_data->>'codigo_rastreamento',
    p_pedido_data->>'id', (p_pedido_data->>'integration_account_id')::UUID,
    2, 'Evento criado automaticamente pelo sistema', v_org_id
  ) RETURNING id INTO new_event_id;
