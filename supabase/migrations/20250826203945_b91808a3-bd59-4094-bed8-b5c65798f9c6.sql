-- Relax join to include records whose integration_account_id can be derived from pedidos
...
AS $$
  WITH org AS (
    ...
    SELECT hv.*, COALESCE(hv.integration_account_id, p.integration_account_id) AS acc_id
