...
-- Inserir unidades padrão para cada organização (trigger para futuras organizações)
...
-- Adicionar campo unidade_medida_id na tabela produtos (inicialmente nullable)
