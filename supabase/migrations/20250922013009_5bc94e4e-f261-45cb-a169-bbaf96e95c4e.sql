-- ===================================================================
-- SECURITY FIX: Customer Data Protection with Data Masking
-- ===================================================================
-- This migration creates a secure view for customer data with automatic
-- masking of sensitive information based on user permissions.

-- 1. Create secure view with data masking for clientes table
...
-- 2. Create secure RPC functions for customer data access
...
-- 4. Create audit log table for customer data access
...
-- Policy for audit log (only admins can read)
...
-- 5. Create enhanced logging function  
